...
class WordCell: BaseCell {
    ...
    private(set) var labelWord = UILabel.labelInfinity(text: nil, font: EnumFont.bold(32))
    var labelTarnlate = UILabel.labelInfinity(text: nil, font: EnumFont.regular(23))
